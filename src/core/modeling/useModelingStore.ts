...
interface ModelingState {
  ...
  // Unhide Dialogs
  unhideDialogOpen: boolean;
  unhidePanelDialogOpen: boolean;
}
...
interface ModelingActions {
  ...
  openUnhidePanelDialog: () => void;
  closeUnhidePanelDialog: () => void;
...
const initialState: ModelingState = {
  ...
  unhideDialogOpen: false,
  unhidePanelDialogOpen: false,
};
...
export const useModelingStore = create<ModelingState & ModelingActions>()(
  immer((set, get) => ({
    ...
    openUnhideDialog: () => {
      set((state) => { state.unhideDialogOpen = true; });
    },
    closeUnhideDialog: () => {
      set((state) => { state.unhideDialogOpen = false; });
    },
    openUnhidePanelDialog: () => {
      set((state) => { state.unhidePanelDialogOpen = true; });
    },
    closeUnhidePanelDialog: () => {
      set((state) => { state.unhidePanelDialogOpen = false; });
    },
