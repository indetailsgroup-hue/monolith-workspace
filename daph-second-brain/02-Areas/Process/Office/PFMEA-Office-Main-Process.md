...
owner: null
document_set: null
source_file: "DAPH PFMEA, Main Process.xlsx"
tags: [domain/process, group/office, unit/sale, unit/area-measurement, unit/designer, unit/3d-perspective, unit/production-planning, type/pfmea, status/active]
---
...
```
FILE: DAPH PFMEA, Main Process.xlsx
SHEETS: DAPH PFMEA
===== SHEET: DAPH PFMEA (rows=72, cols=20) =====
...
R12: 1.Sales Process | เก็บข้อมูลลูกค้า | ไม่เก็บข้อมูลลู
…
```
...
## คำย่อที่เกี่ยวข้อง
[[Glossary#PFMEA|PFMEA]], [[Glossary#RPN|RPN]], [[Glossary#Pytha|Pytha]], [[Glossary#3D_Max|3D Max]]
