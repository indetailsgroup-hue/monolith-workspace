...
sku:
  ...
  - "551H5601T"
source_refs:
  - "BIun 412-535 Runner systems.pdf:p.440"
  - "BIun 412-535 Runner systems.pdf:p.518"
specs:
...
conflicts:
  - field: side_clearance_mm
    note_value: 21
    note_value_evidence: "BIun 412-535 Runner systems.pdf:p.440 'SKW = LW - 42 mm'. Distance to internal drawer side is 21 mm."
    monolith_value: 20.5
...
# Blum TANDEM 551H (16 mm) — Undermount Runners (Single Extension - Hook & Peg)

> draft/review_ready — รางลิ้นชักซ่อนใต้ไม้ TANDEM single extension แบบเกี่ยวและสลักหลัง (Hook & Peg) สำหรับไม้หนา 11–16 mm รับน้ำหนัก 30 kg

## สรุป
รางลิ้นชักซ่อนใต้แบบดึงเปิดได้บางส่วน (Single/partial extension) สำหรับลิ้นชักโครงสร้างไม้ที่มีความหนาแผงข้าง 11–16 mm รับน้ำหนักไดนามิกได้ 30 kg รุ่นเกี่ยวลิ้นชักและใช้สลักหลัง (Hook & Peg) โดยไม่ต้องใช้กิ๊บล็อคหน้าตู้ (Locking Device) 
...
|---|---|---|---|---|
| 260 | 551H2601B | 551H2601T | 30 | p.440, p.518 |
| 285 | 551H2851B | 551H2851T | 30 | p.440, p.518 |
| 310 | 551H3101B | 551H3101T | 30 | p.440, p.518 |
| 335 | 551H3351B | 551H3351T | 30 | p.440, p.518 |
| 360 | 551H3601B | 551H3601T | 30 | p.440, p.518 |
| 385 | 551H3851B | 551H3851T | 30 | p.440, p.518 |
| 410 | 551H4101B | 551H4101T | 30 | p.440, p.518 |
| 435 | 551H4351B | 551H4351T | 30 | p.440, p.518 |
| 460 | 551H4601B | 551H4601T | 30 | p.440, p.518 |
| 485 | 551H4851B | 551H4851T | 30 | p.440, p.518 |
| 510 | 551H5101B | 551H5101T | 30 | p.440, p.518 |
| 535 | 551H5351B | 551H5351T | 30 | p.440, p.518 |
| 560 | 551H5601B | 551H5601T | 30 | p.440, p.518 |
