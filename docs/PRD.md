...
- `docs/DAPH-org-structure-from-JD-2025.md` — โครงสร้างองค์กร/สายบังคับบัญชา/อำนาจอนุมัติ สกัดจาก JD ทางการ 27 ฉบับ (ก.ค. 2025) — SSOT เรื่องตำแหน่งงาน ใช้กับ workflow RACI + IAM roles + Installation PM; `docs/JD-drafts-missing-positions-2026-07.md` — ร่าง JD 6 ตำแหน่งที่ขาด (วัดพื้นที่/3D rendering/การตลาด/โลจิสติกส์)
