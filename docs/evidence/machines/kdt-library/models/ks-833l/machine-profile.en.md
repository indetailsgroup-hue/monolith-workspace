...
| Region | Global |
| Purpose | Panel saw with optimization software |
...
|---|---|---|---|
| Working envelope (`envelope`) | Front feeding 3330x3330x120 / rear feeding 3000x1525mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/4.html) |
| Capabilities (`capabilities`) | Main blade motor 18.5kW (optional 22 variable frequency); scoring 2.2kW; 9 grippers; optimization software | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/4.html) |
| Capacities (`capacities`) | Sawing speed 95 m/min; carrier return 120 m/min | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/4.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | Optimization software | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/4.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total power 35.5kW; overall 7860L x 5645W x 2030H mm; weight 7500kg; dust Ø100*2+Ø125*1+Ø200*2 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/4.html) |
