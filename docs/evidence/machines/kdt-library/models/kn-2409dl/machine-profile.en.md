...
| Model | **KN-2409DL** |
| Aliases | KN2409DL, KN2-2409DL |
| Family | Nesting Tech |
| Catalog status | current-global |
| Region | Global + AU regional |
| Purpose | Flat-bed CNC nesting center with enlarged worktable and 10V drilling head |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/196.html) · [ledamachinery.com.au](https://ledamachinery.com.au/wp-content/uploads/2024/05/KDT-KN2-2409DL-Feature-Benefit.pdf) |
...
|---|---|---|---|
| Working envelope (`envelope`) | 2850*1260*60 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/196.html) |
| Capabilities (`capabilities`) | 10V Drilling Head; 9kW ls0-30 Spindle | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/196.html) |
| Capacities (`capacities`) | feed/speed 100/100/30; vacuum 244 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/196.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | 12-post Linear ATC | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/196.html) |
| Footprint / power / weight (`footprint_power_weight`) | power 22.7; size 4080L*2160W*2450H; dust Ø150*1+Ø100*1 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/196.html) |
