# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KN-2409DL

> `profile_id: kdt.nesting.kn_2409dl@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Nesting Tech** — Flat-bed CNC nesting center with enlarged worktable and 10V drilling head
...
| รุ่น | **KN-2409DL** |
| ชื่อเรียกอื่น (aliases) | KN2409DL, KN2-2409DL |
| ตระกูล | Nesting Tech |
| สถานะในแค็ตตาล็อก | current-global |
| ภูมิภาค | Global + AU regional |
| วัตถุประสงค์การใช้งาน | Flat-bed CNC nesting center with enlarged worktable and 10V drilling head |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/196.html) · [ledamachinery.com.au](https://ledamachinery.com.au/wp-content/uploads/2024/05/KDT-KN2-2409DL-Feature-Benefit.pdf) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | 2850*1260*60 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/196.html) |
| ความสามารถ (`capabilities`) | 10V Drilling Head; 9kW ls0-30 Spindle | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/196.html) |
| กำลัง / ความจุ (`capacities`) | feed/speed 100/100/30; vacuum 244 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/196.html) |
...
| ระบบอัตโนมัติ (`automation`) | 12-post Linear ATC | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/196.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | power 22.7; size 4080L*2160W*2450H; dust Ø150*1+Ø100*1 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/196.html) |
