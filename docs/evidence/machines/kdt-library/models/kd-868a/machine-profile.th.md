# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KD-868A

> `profile_id: kdt.drilling.kd_868a@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Drilling Tech** — Through-feed drilling technology
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Through-feed drilling technology |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel L 200-2800mm x W L/R workstation 45-650/45-800mm x T 9-60mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/146.html) |
| ความสามารถ (`capabilities`) | Drills: Upper 64V+24H, Lower 18V; spindles 5.5kW*2 + 3.5kW*2; through-feed drill tech, double workstation | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/146.html) |
| กำลัง / ความจุ (`capacities`) | Max feeding speed 140 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/146.html) |
...
| ระบบอัตโนมัติ (`automation`) | Double workstation independent; automatic gear positioning; automatic in/out feeding | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/146.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total spindle power 59.5kW; overall 7100L x 4000W x 2190H mm; dust Ø200*4+Ø150*2; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/146.html) |
