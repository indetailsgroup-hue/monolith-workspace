...
| Region | Global |
| Purpose | Through-feed drilling technology |
...
|---|---|---|---|
| Working envelope (`envelope`) | Panel L 200-2800mm x W L/R workstation 45-650/45-800mm x T 9-60mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/146.html) |
| Capabilities (`capabilities`) | Drills: Upper 64V+24H, Lower 18V; spindles 5.5kW*2 + 3.5kW*2; through-feed drill tech, double workstation | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/146.html) |
| Capacities (`capacities`) | Max feeding speed 140 m/min | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/146.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | Double workstation independent; automatic gear positioning; automatic in/out feeding | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/146.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total spindle power 59.5kW; overall 7100L x 4000W x 2190H mm; dust Ø200*4+Ø150*2; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/146.html) |
