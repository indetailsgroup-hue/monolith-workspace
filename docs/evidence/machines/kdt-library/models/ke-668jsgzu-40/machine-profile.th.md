# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KE-668JSGZU(40)
...
| รุ่น | **KE-668JSGZU(40)** |
| ชื่อเรียกอื่น (aliases) | KE-668JSGZU |
| ตระกูล | Banding Machine (Edge Bander) |
| สถานะในแค็ตตาล็อก | current-global |
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Edge bander; pressure beam with V-belts |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/199.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | 40x300 4 sides edging; W Total Power(kW); T 9-60 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/199.html) |
| ความสามารถ (`capabilities`) | tape 0.4-3 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/199.html) |
| กำลัง / ความจุ (`capacities`) | feed/speed 15-24 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/199.html) |
