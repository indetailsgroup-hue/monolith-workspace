# Machine Profile — KDT KE-668JSGZU(40)

> `profile_id: kdt.edge_bander.ke_668jsgzu_40@0.1-research-draft` · as-of: 2026-07-17
> [TH edition / ฉบับภาษาไทย](machine-profile.th.md)

**Banding Machine (Edge Bander)** — Edge bander; pressure beam with V-belts
...
| Model | **KE-668JSGZU(40)** |
| Aliases | KE-668JSGZU |
| Family | Banding Machine (Edge Bander) |
| Catalog status | current-global |
| Region | Global |
| Purpose | Edge bander; pressure beam with V-belts |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/199.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | 40x300 4 sides edging; W Total Power(kW); T 9-60 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/199.html) |
| Capabilities (`capabilities`) | tape 0.4-3 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/199.html) |
| Capacities (`capacities`) | feed/speed 15-24 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/199.html) |
