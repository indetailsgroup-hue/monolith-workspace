...
| Region | Global |
| Purpose | Through-feed drilling; 6 drill sets, 4 router motors |
...
|---|---|---|---|
| Working envelope (`envelope`) | Panel L 200-2800mm x W L/R workstation 45-1220/45-800mm x T 9-60mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/145.html) |
| Capabilities (`capabilities`) | Drills: Upper 64V+24H, Lower 18V; spindles 5.5kW*2 + 3.5kW*2; 6 heads & 4 spindles, ~106 independent drill shafts; drilling capacity 480 PCS/H (listing tagline) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/145.html) |
| Capacities (`capacities`) | Max feeding speed 140 m/min; 480 PCS/H | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/145.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | Dual work-station working independently; automatic in/out feeding | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_list/17.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total spindle power 59.5kW; overall 7100L x 5230W x 2260H mm; dust Ø200*4+Ø150*2; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/145.html) |
