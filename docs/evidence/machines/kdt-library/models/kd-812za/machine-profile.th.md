# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KD-812ZA

> `profile_id: kdt.drilling.kd_812za@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Drilling Tech** — Through-feed drilling; 6 drill sets, 4 router motors
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Through-feed drilling; 6 drill sets, 4 router motors |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel L 200-2800mm x W L/R workstation 45-1220/45-800mm x T 9-60mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/145.html) |
| ความสามารถ (`capabilities`) | Drills: Upper 64V+24H, Lower 18V; spindles 5.5kW*2 + 3.5kW*2; 6 heads & 4 spindles, ~106 independent drill shafts; drilling capacity 480 PCS/H (listing tagline) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/145.html) |
| กำลัง / ความจุ (`capacities`) | Max feeding speed 140 m/min; 480 PCS/H | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/145.html) |
...
| ระบบอัตโนมัติ (`automation`) | Dual work-station working independently; automatic in/out feeding | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_list/17.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total spindle power 59.5kW; overall 7100L x 5230W x 2260H mm; dust Ø200*4+Ø150*2; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/145.html) |
