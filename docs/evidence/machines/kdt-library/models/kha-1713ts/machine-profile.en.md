# Machine Profile — KDT KHA-1713TS
...
| Region | Global |
| Purpose | Loading + labeling platform (four-column screw lift, auto aligner, 90-deg rotation labeling) |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/197.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | Table size 4260x2150mm; panel L 4200, W 2150, T 10-25mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/197.html) |
| Capabilities (`capabilities`) | Loading + labeling platform: four-column screw lift, auto aligner, 90-deg rotation labeling | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/197.html) |
| Capacities (`capacities`) | Stack height with pit 500mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/197.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | Automatic loading + labeling module for nesting cells | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/197.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total power 3.7kW; weight-bearing 3500kg; overall 6080x3340x1765mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/197.html) |
