# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KD-610RH
...
| รุ่น | **KD-610RH** |
| ชื่อเรียกอื่น (aliases) | KD-610 RH |
| ตระกูล | Six-sided drilling |
| สถานะในแค็ตตาล็อก | current-global |
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Compact & cost-effective six-sided CNC drilling center |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel L 70-3000mm x W 30-1000mm x T 9-60mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/151.html) |
| ความสามารถ (`capabilities`) | Drills: Upper 10V+8H, Lower 9V; spindle 1x3.5kW | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/151.html) |
| กำลัง / ความจุ (`capacities`) | Max feeding speed 100 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/151.html) |
...
| ระบบอัตโนมัติ (`automation`) | Through-feed six-sided drilling | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/151.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total spindle power 15.7kW; overall 4115L x 2250W x 2210H mm; dust Ø200*1+Ø150*1; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/151.html) |

## 4. ข้อขัดแย้งที่บันทึกไว้ (ไม่ตัดสินให้)

**ข้อขัดแย้ง (Conflict):** KDT-Greece page for 'KD-610R' lists near-identical figures (15.7kW, 4115x2250x2210, feed 100) suggesting Greece described the RH configuration.
