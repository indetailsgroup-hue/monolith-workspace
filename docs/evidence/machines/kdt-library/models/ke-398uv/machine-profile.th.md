# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KE-398UV
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Edge bander (UV/tilt-straight) |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/211.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | ≥120; W ≥100; T 18-22(25)(J、C) 18-25(Tilt/Straight) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/211.html) |
| ความสามารถ (`capabilities`) | tape 0.5-0.6(J、C) 0.45-1.2(Tilt/Straight) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/211.html) |
| กำลัง / ความจุ (`capacities`) | feed/speed 8 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/211.html) |
...
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | power 62.37 kW; size 11316L*990W*1820H mm; dust Ø125*13 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/211.html) |
