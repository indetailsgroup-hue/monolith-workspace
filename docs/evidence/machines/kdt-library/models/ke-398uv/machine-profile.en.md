# Machine Profile — KDT KE-398UV

> `profile_id: kdt.edge_bander.ke_398uv@0.1-research-draft` · as-of: 2026-07-17
> [TH edition / ฉบับภาษาไทย](machine-profile.th.md)

**Banding Machine (Edge Bander)** — Edge bander (UV/tilt-straight)
...
| Region | Global |
| Purpose | Edge bander (UV/tilt-straight) |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/211.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | ≥120; W ≥100; T 18-22(25)(J、C) 18-25(Tilt/Straight) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/211.html) |
| Capabilities (`capabilities`) | tape 0.5-0.6(J、C) 0.45-1.2(Tilt/Straight) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/211.html) |
| Capacities (`capacities`) | feed/speed 8 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/211.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | power 62.37 kW; size 11316L*990W*1820H mm; dust Ø125*13 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/211.html) |
