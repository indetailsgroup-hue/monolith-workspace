# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KE-368JSUM
...
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/214.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel T 9-60mm; panel L >=120, W >=60; min panel 120x60mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/214.html) |
| ความสามารถ (`capabilities`) | Edge bander; tape 0.4-3mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/214.html) |
| กำลัง / ความจุ (`capacities`) | Feeding speed 15-24 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/214.html) |
...
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 19.02kW; overall 5860x830x1700mm; dust Ø125*6; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/214.html) |
