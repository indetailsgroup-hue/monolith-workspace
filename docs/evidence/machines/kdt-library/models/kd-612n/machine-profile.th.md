# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KD-612N

> `profile_id: kdt.six_sided_drill.kd_612n@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Six-sided drilling** — Six-sided drilling; air flotation
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Six-sided drilling; air flotation |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel L 70-3000mm x W 50-1210mm (30-50 when L<=1000) x T 9-60mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/64.html) |
| ความสามารถ (`capabilities`) | Drills: Upper 13V+10H, Lower 9V; spindles 1x5.5kW + 1x3.5kW; air flotation table | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/64.html) |
| กำลัง / ความจุ (`capacities`) | Max feeding speed 140 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/64.html) |
...
| ระบบอัตโนมัติ (`automation`) | Through-feed; air flotation | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/64.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total spindle power 22.65kW; overall 5900L x 2620W x 2190H mm; dust Ø200*1+Ø150*1; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/64.html) |
