...
| Region | Global |
| Purpose | Six-sided drilling; air flotation |
...
|---|---|---|---|
| Working envelope (`envelope`) | Panel L 70-3000mm x W 50-1210mm (30-50 when L<=1000) x T 9-60mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/64.html) |
| Capabilities (`capabilities`) | Drills: Upper 13V+10H, Lower 9V; spindles 1x5.5kW + 1x3.5kW; air flotation table | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/64.html) |
| Capacities (`capacities`) | Max feeding speed 140 m/min | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/64.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | Through-feed; air flotation | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/64.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total spindle power 22.65kW; overall 5900L x 2620W x 2190H mm; dust Ø200*1+Ø150*1; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/64.html) |
