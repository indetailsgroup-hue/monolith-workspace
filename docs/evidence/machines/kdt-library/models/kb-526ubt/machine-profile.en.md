# Machine Profile — KDT KB-526UBT

> `profile_id: kdt.edge_bander.kb_526ubt@0.1-research-draft` · as-of: 2026-07-17
...
| Model | **KB-526UBT** |
| Aliases | KB-526UBT laser 3.0S |
| Family | Banding Machine (Edge Bander) |
| Catalog status | current-global |
| Region | Global |
| Purpose | Laser 3.0S edge bander |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/204.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | sides edging:30x300; W Min. Panel Size(mm); T (Standard)：8-60 (Laser)：8-36 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/204.html) |
| Capabilities (`capabilities`) | tape (Standard)：0.4-3 (Laser)：0.8-3 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/204.html) |
| Capacities (`capacities`) | feed/speed 18-22-26-30 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/204.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | power 45.65 激光(Laser)：3.0; size 10680L*1150W*1830H mm; dust Ø125*8+Ø75*1 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/204.html) |
