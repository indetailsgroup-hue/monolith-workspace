# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KB-526UBT
...
| รุ่น | **KB-526UBT** |
| ชื่อเรียกอื่น (aliases) | KB-526UBT laser 3.0S |
| ตระกูล | Banding Machine (Edge Bander) |
| สถานะในแค็ตตาล็อก | current-global |
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Laser 3.0S edge bander |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/204.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | sides edging:30x300; W Min. Panel Size(mm); T (Standard)：8-60 (Laser)：8-36 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/204.html) |
| ความสามารถ (`capabilities`) | tape (Standard)：0.4-3 (Laser)：0.8-3 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/204.html) |
| กำลัง / ความจุ (`capacities`) | feed/speed 18-22-26-30 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/204.html) |
...
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | power 45.65 激光(Laser)：3.0; size 10680L*1150W*1830H mm; dust Ø125*8+Ø75*1 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/204.html) |
