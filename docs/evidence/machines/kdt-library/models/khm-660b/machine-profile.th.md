# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KHM-660B
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Key-hole & hinge machining |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel W 300-1200mm; panel L 1800-3000mm; panel T 30-70mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/87.html) |
| ความสามารถ (`capabilities`) | Key-hole & hinge machining; horizontal spindle 6kW(ER32)+1.5kW(ER20)+0.75kW(ER20); door-lock + hinge machining | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/87.html) |
| กำลัง / ความจุ (`capacities`) | X/Y/Z servo 1.5kW; max moving speed 60 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/87.html) |
...
| ระบบอัตโนมัติ (`automation`) | Door key-hole/hinge machining unit | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/87.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 35.3kW; overall 5275L x 3250W x 1975H mm; dust Ø200*2; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/87.html) |
