# โปรไฟล์เครื่องจักร (Machine Profile) — KDT Whole Plant Planning 1
...
| ระบบอัตโนมัติ (`automation`) | Integration/solution concept (no discrete machine spec table published) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/109.html) |
