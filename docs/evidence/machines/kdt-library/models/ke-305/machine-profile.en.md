# Machine Profile — KDT KE-305

> `profile_id: kdt.edge_bander.ke_305@0.1-research-draft` · as-of: 2026-07-17
> [TH edition / ฉบับภาษาไทย](machine-profile.th.md)

**Banding Machine (Edge Bander)** — Manual edge bander
...
| Region | Global |
| Purpose | Manual edge bander |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/198.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | T 9~55 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/198.html) |
| Capabilities (`capabilities`) | tape 0.4-3 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/198.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | power 2.45; size 1010L*1060W*1000H | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/198.html) |
