# โปรไฟล์เครื่องจักร (Machine Profile) — KDT Nesting automation line

> `profile_id: kdt.project_planning.nesting_automation_line@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Project Planning (Lines/Cells)** — Nesting automation line with column-mounted four-axis robot
...
| รุ่น | **Nesting automation line** |
| ชื่อเรียกอื่น (aliases) | ไม่มี |
| ตระกูล | Project Planning (Lines/Cells) |
| สถานะในแค็ตตาล็อก | current-global |
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Nesting automation line with column-mounted four-axis robot |
...
| ระบบอัตโนมัติ (`automation`) | Integration/solution concept (no discrete machine spec table published) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/97.html) |
...
**1 / 7** — จำนวนกลุ่มข้อมูลเทคนิคที่มีค่าและมีแหล่งอ้างอิง จากทั้งหมด 7 กลุ่ม · ณ วันที่ 2026-07-17
