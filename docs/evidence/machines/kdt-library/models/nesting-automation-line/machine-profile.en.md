# Machine Profile — KDT Nesting automation line
...
| Model | **Nesting automation line** |
| Aliases | none |
| Family | Project Planning (Lines/Cells) |
| Catalog status | current-global |
| Region | Global |
| Purpose | Nesting automation line with column-mounted four-axis robot |
...
| Automation (`automation`) | Integration/solution concept (no discrete machine spec table published) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/97.html) |
...
**1 / 7** — Populated technical field-groups with a source-cited value, out of 7. · As of 2026-07-17
