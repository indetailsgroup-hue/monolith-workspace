# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KS-828DL
...
| รุ่น | **KS-828DL** |
| ชื่อเรียกอื่น (aliases) | KS-828D |
| ตระกูล | Saw Tech |
| สถานะในแค็ตตาล็อก | current-global |
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Rear loading panel saw |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Max working size (L*W) 3330 x 3330mm; max cutting thickness 120mm | ยืนยันจากเอกสาร (Verified in documents) | [www.kdtmac.com](https://www.kdtmac.com/products_details/162.html) |
| ความสามารถ (`capabilities`) | Main saw motor 18.5kW (3800 r/min); scoring 2.2kW (5300 r/min); main blade Ø450xØ75, scoring Ø200xØ50; saw carriage servo 2kW; feeding servo 2kW; grooving supported | ยืนยันจากเอกสาร (Verified in documents) | [www.kdtmac.com](https://www.kdtmac.com/products_details/162.html) |
| กำลัง / ความจุ (`capacities`) | Cutting speed max 95 m/min; saw carriage return max 120 m/min; feeding max 95 m/min; air consumption 320 L/min | ยืนยันจากเอกสาร (Verified in documents) | [www.kdtmac.com](https://www.kdtmac.com/products_details/162.html) |
...
| ระบบอัตโนมัติ (`automation`) | Main saw auto position; scoring saw electric adjustment; side-aligner; lift table load 3000kg; max loading board 2800x1220 | ยืนยันจากเอกสาร (Verified in documents) | [www.kdtmac.com](https://www.kdtmac.com/products_details/162.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Rated/total power 35.5kW; weight Unknown; dimensions Unknown on official page; grippers Unknown | ยืนยันจากเอกสาร (Verified in documents) | [www.kdtmac.com](https://www.kdtmac.com/products_details/162.html) |

## 4. ข้อขัดแย้งที่บันทึกไว้ (ไม่ตัดสินให้)

**ข้อขัดแย้ง (Conflict):** KDT-official page (products_details/162) omits weight, overall size, grippers.
