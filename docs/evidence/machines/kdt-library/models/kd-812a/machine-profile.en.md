...
| Region | Global |
| Purpose | Through-feed drilling; capacity 480 pcs/h |
...
|---|---|---|---|
| Working envelope (`envelope`) | Panel L 200-2800mm x W L/R workstation 45-1220/45-800mm x T 9-60mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/161.html) |
| Capabilities (`capabilities`) | Drills: Upper 64V+24H, Lower 18V; spindles 5.5kW*2 + 3.5kW*2; drilling capacity 480 PCS/H | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/161.html) |
| Capacities (`capacities`) | Max feeding speed 140 m/min; 480 PCS/H | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/161.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | Dual work-station working independently | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/161.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total spindle power 59.5kW; overall 7100L x 4920W x 2190H mm; dust Ø200*4+Ø150*2; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/161.html) |

## 4. Documented conflicts (not resolved)

**Conflict:** Same drill/power spec as KD-812ZA but different footprint (7100x4920x2190 vs 7100x5230x2260).
