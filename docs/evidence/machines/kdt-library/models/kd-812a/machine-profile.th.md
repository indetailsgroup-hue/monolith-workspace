# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KD-812A

> `profile_id: kdt.drilling.kd_812a@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Drilling Tech** — Through-feed drilling; capacity 480 pcs/h
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Through-feed drilling; capacity 480 pcs/h |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel L 200-2800mm x W L/R workstation 45-1220/45-800mm x T 9-60mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/161.html) |
| ความสามารถ (`capabilities`) | Drills: Upper 64V+24H, Lower 18V; spindles 5.5kW*2 + 3.5kW*2; drilling capacity 480 PCS/H | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/161.html) |
| กำลัง / ความจุ (`capacities`) | Max feeding speed 140 m/min; 480 PCS/H | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/161.html) |
...
| ระบบอัตโนมัติ (`automation`) | Dual work-station working independently | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/161.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total spindle power 59.5kW; overall 7100L x 4920W x 2190H mm; dust Ø200*4+Ø150*2; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/161.html) |

## 4. ข้อขัดแย้งที่บันทึกไว้ (ไม่ตัดสินให้)

**ข้อขัดแย้ง (Conflict):** Same drill/power spec as KD-812ZA but different footprint (7100x4920x2190 vs 7100x5230x2260).
