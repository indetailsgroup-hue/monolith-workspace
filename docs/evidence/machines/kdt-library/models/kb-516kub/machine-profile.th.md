# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KB-516KUB
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | 35-degree end-cutting unit / edge bander |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/194.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | T 8-60 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/194.html) |
| ความสามารถ (`capabilities`) | tape 0.4-3 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/194.html) |
| กำลัง / ความจุ (`capacities`) | feed/speed 18-26 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/194.html) |
...
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | power 31.88; size 9980L*1150W*1960H; dust Ø100*2+Ø125*7 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/194.html) |
