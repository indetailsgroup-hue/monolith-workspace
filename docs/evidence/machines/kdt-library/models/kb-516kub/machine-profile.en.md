# Machine Profile — KDT KB-516KUB

> `profile_id: kdt.edge_bander.kb_516kub@0.1-research-draft` · as-of: 2026-07-17
> [TH edition / ฉบับภาษาไทย](machine-profile.th.md)

**Banding Machine (Edge Bander)** — 35-degree end-cutting unit / edge bander
...
| Region | Global |
| Purpose | 35-degree end-cutting unit / edge bander |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/194.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | T 8-60 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/194.html) |
| Capabilities (`capabilities`) | tape 0.4-3 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/194.html) |
| Capacities (`capacities`) | feed/speed 18-26 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/194.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | power 31.88; size 9980L*1150W*1960H; dust Ø100*2+Ø125*7 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/194.html) |
