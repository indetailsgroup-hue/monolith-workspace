# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KD-612T
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Six-sided drilling; dual drill package (26V+18H) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel L 70-3000mm x W 50-1220mm (30-50 when L<=1000) x T 9-60mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/63.html) |
| ความสามารถ (`capabilities`) | Drills: Upper 12V+8H, Lower 18V; spindles 1x5.5kW + 1x3.5kW; dual drill package | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/63.html) |
| กำลัง / ความจุ (`capacities`) | Max feeding speed 140 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/63.html) |
...
| ระบบอัตโนมัติ (`automation`) | Through-feed dual drill package (26V+18H marketing tagline) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/63.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total spindle power 31.92kW; overall 6040L x 2855W x 2190H mm; dust Ø200*2+Ø150*1+Ø100*1; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/63.html) |

## 4. ข้อขัดแย้งที่บันทึกไว้ (ไม่ตัดสินให้)

**ข้อขัดแย้ง (Conflict):** Page tagline says '26V+18H' but spec table lists Upper 12V+8H + Lower 18V.
