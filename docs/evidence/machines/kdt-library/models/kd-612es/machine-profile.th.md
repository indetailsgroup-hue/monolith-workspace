# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KD-612ES
...
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/218.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | 70-3000; W 30-1220; T 9-60 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/218.html) |
| ความสามารถ (`capabilities`) | Upper 20V+12H+Lower 9V; 2*3.5 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/218.html) |
| กำลัง / ความจุ (`capacities`) | feed/speed 140 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/218.html) |
...
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | power 25.1; size 4460L*2855W*2190H; dust Ø200*2+Ø150*1 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/218.html) |
