# Machine Profile — KDT KD-612ES

> `profile_id: kdt.six_sided_drill.kd_612es@0.1-research-draft` · as-of: 2026-07-17
...
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/218.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | 70-3000; W 30-1220; T 9-60 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/218.html) |
| Capabilities (`capabilities`) | Upper 20V+12H+Lower 9V; 2*3.5 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/218.html) |
| Capacities (`capacities`) | feed/speed 140 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/218.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | power 25.1; size 4460L*2855W*2190H; dust Ø200*2+Ø150*1 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/218.html) |
