# Machine Profile — KDT KE-396JC

> `profile_id: kdt.edge_bander.ke_396jc@0.1-research-draft` · as-of: 2026-07-17
...
| Region | Global |
| Purpose | Edge bander |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/213.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | Panel T 9-25mm; panel L >=300, W >=150; min panel 300x150mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/213.html) |
| Capabilities (`capabilities`) | Bevel edge bander; tape 0.5-0.8mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/213.html) |
| Capacities (`capacities`) | Feeding speed 10 m/min | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/213.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | Total power 32.43kW; overall 7087x830x1700mm; dust Ø125*8; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/213.html) |
