# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KE-396JC
...
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/213.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel T 9-25mm; panel L >=300, W >=150; min panel 300x150mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/213.html) |
| ความสามารถ (`capabilities`) | Bevel edge bander; tape 0.5-0.8mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/213.html) |
| กำลัง / ความจุ (`capacities`) | Feeding speed 10 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/213.html) |
...
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 32.43kW; overall 7087x830x1700mm; dust Ø125*8; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/213.html) |
