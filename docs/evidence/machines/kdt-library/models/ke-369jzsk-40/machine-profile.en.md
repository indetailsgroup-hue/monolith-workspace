# Machine Profile — KDT KE-369JZSK(40)

> `profile_id: kdt.edge_bander.ke_369jzsk_40@0.1-research-draft` · as-of: 2026-07-17
...
| Region | Global |
| Purpose | Edge bander |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/209.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | 40x300 4 sides edging; W Total Power(kW); T 9-60 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/209.html) |
| Capabilities (`capabilities`) | tape 0.4-3 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/209.html) |
| Capacities (`capacities`) | feed/speed 15-24 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/209.html) |
