...
| Region | Global |
| Purpose | Through-feed drilling with positioning devices |
...
|---|---|---|---|
| Working envelope (`envelope`) | Panel L 70-3000mm x W L/R workstation 35-650/35-800mm x T 9-60mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/147.html) |
| Capabilities (`capabilities`) | Drills: Upper 64V+24H, Lower 18V; spindles 5.5kW*2 + 3.5kW*2; positioning devices | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/147.html) |
| Capacities (`capacities`) | Max feeding speed 140 m/min | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/147.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | Dual work-station; positioning devices | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/147.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total spindle power 54.2kW; overall 6040L x 4000W x 2190H mm; dust Ø200*4+Ø150*2; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/147.html) |
