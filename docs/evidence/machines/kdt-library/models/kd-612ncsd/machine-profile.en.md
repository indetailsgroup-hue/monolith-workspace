# Machine Profile — KDT KD-612NCSD
...
| Region | Global |
| Purpose | Six-sided drilling; side routering |
...
|---|---|---|---|
| Working envelope (`envelope`) | Panel L 70-3000mm x W 50-1220mm (35-50 when L<=1000) x T 9-60mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/149.html) |
| Capabilities (`capabilities`) | Drills: Upper 26V+16H, Lower 9V; spindles upper 5.5+6kW, lower 2x3.5kW; side routering | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/149.html) |
| Capacities (`capacities`) | Max feeding speed 140 m/min | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/149.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | Through-feed; side routering | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/149.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total power 37.22kW; overall 6040L x 3450W x 2190H mm; dust Ø200*2+Ø150*1+Ø100*1; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/149.html) |
