# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KD-612NCSD

> `profile_id: kdt.six_sided_drill.kd_612ncsd@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Six-sided drilling** — Six-sided drilling; side routering
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Six-sided drilling; side routering |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel L 70-3000mm x W 50-1220mm (35-50 when L<=1000) x T 9-60mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/149.html) |
| ความสามารถ (`capabilities`) | Drills: Upper 26V+16H, Lower 9V; spindles upper 5.5+6kW, lower 2x3.5kW; side routering | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/149.html) |
| กำลัง / ความจุ (`capacities`) | Max feeding speed 140 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/149.html) |
...
| ระบบอัตโนมัติ (`automation`) | Through-feed; side routering | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/149.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 37.22kW; overall 6040L x 3450W x 2190H mm; dust Ø200*2+Ø150*1+Ø100*1; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/149.html) |
