# Machine Profile — KDT Automation Cell with multi-machines integration 2
...
| Model | **Automation Cell with multi-machines integration 2** |
| Aliases | none |
| Family | Automation |
...
| Automation (`automation`) | Integration/solution concept (no discrete machine spec table published) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/101.html) |
