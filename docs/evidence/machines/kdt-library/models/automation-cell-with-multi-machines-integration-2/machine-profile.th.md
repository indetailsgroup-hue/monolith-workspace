# โปรไฟล์เครื่องจักร (Machine Profile) — KDT Automation Cell with multi-machines integration 2

> `profile_id: kdt.automation.automation_cell_with_multi_machines_integration_2@0.1-research-draft` · as-of: 2026-07-17
...
| รุ่น | **Automation Cell with multi-machines integration 2** |
| ชื่อเรียกอื่น (aliases) | ไม่มี |
| ตระกูล | Automation |
| สถานะในแค็ตตาล็อก | current-global |
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Automation cell / robot integration module |
...
| ระบบอัตโนมัติ (`automation`) | Integration/solution concept (no discrete machine spec table published) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/101.html) |
