# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KN-5516P
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Nesting machining center |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Working X/Y/Z 5150 x 1500 x 200mm; travel X 6080 / Y 3050 / Z 640mm; B +/-120deg, C +/-320deg | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/13.html) |
| ความสามารถ (`capabilities`) | 5-axis heads (B/C axis 90deg/s); water-cooled high-power electric spindle imported from Italy; Italian OSA system | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/13.html) |
| กำลัง / ความจุ (`capacities`) | Max moving speed X 80 / Y 80 / Z1(5-axis) 25 / Z2(drill) 25 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/13.html) |
| คอนโทรลเลอร์ / HMI (`controller_hmi`) | Italian OSA system (listing tagline) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_list/10.html) |
| ฟอร์แมต native / import (`native_import_formats`) | Unknown | ยังไม่ทราบ (Unknown) | ไม่มี |
| ระบบอัตโนมัติ (`automation`) | Super-large tool magazine up to 44 tools | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/13.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 29.65kW; overall 7830L x 4365W x 3100H mm; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/13.html) |
...
| | |
|---|---|
| ผู้ผลิตคอนโทรลเลอร์ | Italian OSA system (listing tagline) ([en.kdtmac.com](https://en.kdtmac.com/products_list/10.html)) |
