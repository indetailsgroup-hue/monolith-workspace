# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KN-3710D
...
| ภูมิภาค | Global + UA regional (nesting line) |
| วัตถุประสงค์การใช้งาน | Nesting; high-power spindle for routing |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_list/3.html) · [hydrolider.com.ua](https://hydrolider.com.ua/p2040555935-avtomaticheskaya-liniya-kdt.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Working X/Y/Z 3100x2150x100mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/27.html) |
| ความสามารถ (`capabilities`) | Main spindle 13.2kW HSK-F63 (HSD Italy per distributor); drill head 10V | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/27.html) |
| กำลัง / ความจุ (`capacities`) | Max moving speed 80/80/30 m/min; vacuum 6 zones, 244*2 m3/h | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/27.html) |
| คอนโทรลเลอร์ / HMI (`controller_hmi`) | TPA (Italy) control per distributor hydrolider (distributor claim, not KDT-confirmed) | ยืนยันจากเอกสาร (Verified in documents) | [hydrolider.com.ua](https://hydrolider.com.ua/p2040555935-avtomaticheskaya-liniya-kdt.html) |
| ฟอร์แมต native / import (`native_import_formats`) | Unknown | ยังไม่ทราบ (Unknown) | ไม่มี |
| ระบบอัตโนมัติ (`automation`) | 12-post Rotary ATC; 2x Becker vacuum pumps 5.5kW (distributor) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/27.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 32.8kW; overall 4500x3350x2415mm; weight 5000kg (distributor) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/27.html) |

## 4. ข้อขัดแย้งที่บันทึกไว้ (ไม่ตัดสินให้)

**ข้อขัดแย้ง (Conflict):** KDT-official exhibition gives spindle as KDT 13.2kW HSK-F63; distributor attributes it to HSD (Italy) with TPA control - distributor-specific configuration.
...
| | |
|---|---|
| ผู้ผลิตคอนโทรลเลอร์ | TPA (Italy) control per distributor hydrolider (distributor claim, not KDT-confirmed) ([hydrolider.com.ua](https://hydrolider.com.ua/p2040555935-avtomaticheskaya-liniya-kdt.html)) |
