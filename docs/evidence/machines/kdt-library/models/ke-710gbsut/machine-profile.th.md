# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KE-710GBSUT
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel T 9-60mm (std) / 9-36mm (laser); panel L >=120, W >=90; min panel 120x90mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/144.html) |
| ความสามารถ (`capabilities`) | Edge bander w/ Laser 3.0 S; standard tape 0.4-3mm, laser 0.8-3mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/144.html) |
| กำลัง / ความจุ (`capacities`) | Feeding speed 15-18-24 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/144.html) |
...
| ระบบอัตโนมัติ (`automation`) | Laser edge banding (Laser 3.0 S) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/144.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 37.94kW (+3.0 laser); overall 8800L x 990W x 1800H mm; dust Ø125*7+Ø75*1; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/144.html) |
