...
| Region | Global |
| Purpose | Nesting; large working table |
...
|---|---|---|---|
| Working envelope (`envelope`) | Working X/Y/Z 3100 x 2150 x 60mm (large working table) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_details/174.html) |
| Capabilities (`capabilities`) | Main spindle 9kW ISO-30, single spindle; absolute servo drive | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_details/174.html) |
| Capacities (`capacities`) | Max moving speed X/Y/Z 80/80/30 m/min; vacuum 6 zones, 244*2 m3/h (products_details) / 2*250 m3/h (products_detail 174 English page) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_details/174.html) |
| Controller / HMI (`controller_hmi`) | LNC control system | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_details/174.html) |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | 12-post Linear ATC | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_details/174.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total power 26kW; overall 4330L x 2900W x 2450H mm; dust Ø150*1; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/174.html) |

## 4. Documented conflicts (not resolved)

**Conflict:** Vacuum stated as 244*2 m3/h on exhibition/products_details page vs 2*250 m3/h on products_detail/174 English spec page.
...
| | |
|---|---|
| Controller vendor | LNC control system ([en.kdtmac.com](https://en.kdtmac.com/products_details/174.html)) |
