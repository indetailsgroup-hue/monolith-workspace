# Compatibility Assessment — KDT KN-2710L

> `assessment: MCA-KN-2710L@0.1` · `profile: kdt.nesting.kn_2710l@0.1-research-draft` · `contract: DELIVERY-KN-2710L@0.1-draft`
...
- Validate the nest sheet size against the documented working X/Y/Z envelope.
- Confirm all toolpaths and parts fall inside the reachable field and clamp/vacuum zones.
- Reject sheets larger than the documented envelope or thinner/thicker than documented limits.
