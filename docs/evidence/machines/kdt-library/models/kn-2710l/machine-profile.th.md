# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KN-2710L

> `profile_id: kdt.nesting.kn_2710l@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Nesting Tech** — Nesting; large working table
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Nesting; large working table |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_list/3.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Working X/Y/Z 3100 x 2150 x 60mm (large working table) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_details/174.html) |
| ความสามารถ (`capabilities`) | Main spindle 9kW ISO-30, single spindle; absolute servo drive | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_details/174.html) |
| กำลัง / ความจุ (`capacities`) | Max moving speed X/Y/Z 80/80/30 m/min; vacuum 6 zones, 244*2 m3/h (products_details) / 2*250 m3/h (products_detail 174 English page) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_details/174.html) |
| คอนโทรลเลอร์ / HMI (`controller_hmi`) | LNC control system | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_details/174.html) |
| ฟอร์แมต native / import (`native_import_formats`) | Unknown | ยังไม่ทราบ (Unknown) | ไม่มี |
| ระบบอัตโนมัติ (`automation`) | 12-post Linear ATC | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_details/174.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 26kW; overall 4330L x 2900W x 2450H mm; dust Ø150*1; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/174.html) |

## 4. ข้อขัดแย้งที่บันทึกไว้ (ไม่ตัดสินให้)

**ข้อขัดแย้ง (Conflict):** Vacuum stated as 244*2 m3/h on exhibition/products_details page vs 2*250 m3/h on products_detail/174 English spec page.
...
| | |
|---|---|
| ผู้ผลิตคอนโทรลเลอร์ | LNC control system ([en.kdtmac.com](https://en.kdtmac.com/products_details/174.html)) |
