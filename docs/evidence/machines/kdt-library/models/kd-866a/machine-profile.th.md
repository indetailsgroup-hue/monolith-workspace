# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KD-866A
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Through-feed drilling; reduced footprint |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel L 200-1600mm x W L/R workstation 45-650/45-650mm x T 9-60mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/162.html) |
| ความสามารถ (`capabilities`) | Drills: Upper 26V+20H, Lower 18V; spindles 5.5kW*2 + 3.5kW*2; footprint reduced variant | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/162.html) |
| กำลัง / ความจุ (`capacities`) | Max feeding speed 140 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/162.html) |
...
| ระบบอัตโนมัติ (`automation`) | Dual work-station | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/162.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total spindle power 49.1kW; overall 4700L x 4000W x 2190H mm; dust Ø200*2+Ø150*2; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/162.html) |

## 4. ข้อขัดแย้งที่บันทึกไว้ (ไม่ตัดสินให้)

**ข้อขัดแย้ง (Conflict):** Exhibition id 162 (en.kdtmac.com) = KD-866A; note www.kdtmac.com/products_details/162.html is KS-828DL (different numbering space between exhibition vs products_details).
