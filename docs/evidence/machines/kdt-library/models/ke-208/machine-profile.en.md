...
| Region | Global |
| Purpose | Door frame grooving machine |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/1448642829637804032.html) |
...
**Conflict:** KDT-official detail page (id 1448642829637804032) is image-only; no OCR-legible spec table and no distributor spec table located. All technical fields remain Unknown per grounding rule.
