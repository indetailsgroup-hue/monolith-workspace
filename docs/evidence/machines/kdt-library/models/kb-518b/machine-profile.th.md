# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KB-518B

> `profile_id: kdt.edge_bander.kb_518b@0.1-research-draft` · as-of: 2026-07-17
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Laser 3.0S edge bander |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel T 8-60mm (standard) / 8-36mm (laser); 4-side edging min 40x300mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/168.html) |
| ความสามารถ (`capabilities`) | Double plates trimming & scraping unit; standard tape 0.4-3mm, laser 0.8-3mm; Laser 3.0S option (3.0kW) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/30.html) |
| กำลัง / ความจุ (`capacities`) | Feeding 18-26 m/min (standard) / 18-22-26 (laser variant) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/168.html) |
...
| ระบบอัตโนมัติ (`automation`) | Laser edge banding option (Laser 3.0 S) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/30.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 34.95kW (standard) / 46.32kW (Laser 3.0S); overall 11889x1150x1960mm (std) / 11889x1150x1830H (laser); dust Ø100*2+Ø125*8 (std) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/168.html) |

## 4. ข้อขัดแย้งที่บันทึกไว้ (ไม่ตัดสินให้)

**ข้อขัดแย้ง (Conflict):** Two official variants: KB-518B standard (34.95kW, 1960H, feed 18-26) vs KB-518B Laser 3.0 S (46.32kW incl 3.0 laser, 1830H, feed 18-22-26).
