...
|---|---|---|---|
| Working envelope (`envelope`) | Panel T 8-60mm (standard) / 8-36mm (laser); 4-side edging min 40x300mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/168.html) |
| Capabilities (`capabilities`) | Double plates trimming & scraping unit; standard tape 0.4-3mm, laser 0.8-3mm; Laser 3.0S option (3.0kW) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/30.html) |
| Capacities (`capacities`) | Feeding 18-26 m/min (standard) / 18-22-26 (laser variant) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/168.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | Laser edge banding option (Laser 3.0 S) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/30.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total power 34.95kW (standard) / 46.32kW (Laser 3.0S); overall 11889x1150x1960mm (std) / 11889x1150x1830H (laser); dust Ø100*2+Ø125*8 (std) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/168.html) |

## 4. Documented conflicts (not resolved)

**Conflict:** Two official variants: KB-518B standard (34.95kW, 1960H, feed 18-26) vs KB-518B Laser 3.0 S (46.32kW incl 3.0 laser, 1830H, feed 18-22-26).
