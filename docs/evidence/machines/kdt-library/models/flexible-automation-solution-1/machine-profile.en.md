# Machine Profile — KDT Flexible Automation Solution 1
...
| Model | **Flexible Automation Solution 1** |
| Aliases | none |
...
|---|---|---|---|
| Working envelope (`envelope`) | Whole-line working height 920+/-30mm; working length 200-2800mm; width 50-1200mm; thickness 10-25mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/81.html) |
| Capabilities (`capabilities`) | Flexible automation solution (edge-banding/handling line integration concept) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/81.html) |
...
| Automation (`automation`) | Line-level flexible automation; specific integrated machines not enumerated on page | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/81.html) |
| Footprint / power / weight (`footprint_power_weight`) | Unknown | Unknown | none |

## 4. Documented conflicts (not resolved)

**Conflict:** Solution-level concept page: only whole-line envelope stated; per-machine power/footprint/weight Unknown.
