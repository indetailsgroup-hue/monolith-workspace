# โปรไฟล์เครื่องจักร (Machine Profile) — KDT Flexible Automation Solution 1

> `profile_id: kdt.project_planning.flexible_automation_solution_1@0.1-research-draft` · as-of: 2026-07-17
...
| รุ่น | **Flexible Automation Solution 1** |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Whole-line working height 920+/-30mm; working length 200-2800mm; width 50-1200mm; thickness 10-25mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/81.html) |
| ความสามารถ (`capabilities`) | Flexible automation solution (edge-banding/handling line integration concept) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/81.html) |
...
| ระบบอัตโนมัติ (`automation`) | Line-level flexible automation; specific integrated machines not enumerated on page | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/81.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Unknown | ยังไม่ทราบ (Unknown) | ไม่มี |

## 4. ข้อขัดแย้งที่บันทึกไว้ (ไม่ตัดสินให้)

**ข้อขัดแย้ง (Conflict):** Solution-level concept page: only whole-line envelope stated; per-machine power/footprint/weight Unknown.
