# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KN-3710DE

> `profile_id: kdt.nesting.kn_3710de@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Nesting Tech** — Nesting; high-power spindle for routing (E variant)
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Nesting; high-power spindle for routing (E variant) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Working X/Y/Z 3100 x 2150 x 100mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/190.html) |
| ความสามารถ (`capabilities`) | Main spindle 12kW ISO-30; drilling head 10V | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/190.html) |
| กำลัง / ความจุ (`capacities`) | Max moving speed X/Y/Z 80/80/30 m/min; vacuum 6 zones, 244*2 m3/h | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/190.html) |
...
| ระบบอัตโนมัติ (`automation`) | 12-post Rotary ATC | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/190.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 31.6kW; overall 4500L x 3350W x 2415H mm; dust Ø200*1; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/190.html) |
