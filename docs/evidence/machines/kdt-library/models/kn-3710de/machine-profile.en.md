...
| Region | Global |
| Purpose | Nesting; high-power spindle for routing (E variant) |
...
|---|---|---|---|
| Working envelope (`envelope`) | Working X/Y/Z 3100 x 2150 x 100mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/190.html) |
| Capabilities (`capabilities`) | Main spindle 12kW ISO-30; drilling head 10V | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/190.html) |
| Capacities (`capacities`) | Max moving speed X/Y/Z 80/80/30 m/min; vacuum 6 zones, 244*2 m3/h | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/190.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | 12-post Rotary ATC | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/190.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total power 31.6kW; overall 4500L x 3350W x 2415H mm; dust Ø200*1; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/190.html) |
