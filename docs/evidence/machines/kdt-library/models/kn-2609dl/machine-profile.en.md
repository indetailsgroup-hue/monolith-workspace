...
| Region | Global |
| Purpose | Nesting; enlarged worktable |
...
|---|---|---|---|
| Working envelope (`envelope`) | Working X/Y/Z 2850 x 1860 x 60mm (enlarged worktable) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/120.html) |
| Capabilities (`capabilities`) | Main spindle 9kW ISO-30; drilling head 10V | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/120.html) |
| Capacities (`capacities`) | Max moving speed X/Y/Z 80/80/30 m/min; vacuum 6 zones, 244*2 m3/h | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/120.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | 12-post Linear ATC | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/120.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total power 28.2kW; overall 4080L x 2800W x 2450H mm; dust Ø150*1; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/120.html) |
