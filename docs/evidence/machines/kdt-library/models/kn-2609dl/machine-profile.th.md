# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KN-2609DL

> `profile_id: kdt.nesting.kn_2609dl@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Nesting Tech** — Nesting; enlarged worktable
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Nesting; enlarged worktable |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Working X/Y/Z 2850 x 1860 x 60mm (enlarged worktable) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/120.html) |
| ความสามารถ (`capabilities`) | Main spindle 9kW ISO-30; drilling head 10V | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/120.html) |
| กำลัง / ความจุ (`capacities`) | Max moving speed X/Y/Z 80/80/30 m/min; vacuum 6 zones, 244*2 m3/h | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/120.html) |
...
| ระบบอัตโนมัติ (`automation`) | 12-post Linear ATC | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/120.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 28.2kW; overall 4080L x 2800W x 2450H mm; dust Ø150*1; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/120.html) |
