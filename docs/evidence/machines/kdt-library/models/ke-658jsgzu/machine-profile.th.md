# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KE-658JSGZU
...
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/215.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel T 9-60mm; panel L >=120, W >=90; min panel 120x90mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/215.html) |
| ความสามารถ (`capabilities`) | Edge bander; tape 0.4-3mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/215.html) |
| กำลัง / ความจุ (`capacities`) | Feeding speed 15-24 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/215.html) |
...
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 25.86kW; overall 7200x995x1730mm; dust Ø125*6; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/215.html) |
