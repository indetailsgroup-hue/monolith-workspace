# Machine Profile — KDT KE-658JSGZU

> `profile_id: kdt.edge_bander.ke_658jsgzu@0.1-research-draft` · as-of: 2026-07-17
...
| Region | Global |
| Purpose | Edge bander |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/215.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | Panel T 9-60mm; panel L >=120, W >=90; min panel 120x90mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/215.html) |
| Capabilities (`capabilities`) | Edge bander; tape 0.4-3mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/215.html) |
| Capacities (`capacities`) | Feeding speed 15-24 m/min | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/215.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | Total power 25.86kW; overall 7200x995x1730mm; dust Ø125*6; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/215.html) |
