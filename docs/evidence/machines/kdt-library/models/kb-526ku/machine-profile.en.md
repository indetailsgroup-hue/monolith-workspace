...
| Region | Global |
| Purpose | Edge bander |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/207.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | T 8-60 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/207.html) |
| Capabilities (`capabilities`) | tape 0.4-3 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/207.html) |
| Capacities (`capacities`) | feed/speed 18-22-26-30 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/207.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | power 35.98kW; size 10414L*1150W*1960H mm; dust Ø125×8 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/207.html) |
