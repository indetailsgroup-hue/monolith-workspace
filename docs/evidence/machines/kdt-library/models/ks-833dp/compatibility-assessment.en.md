# Compatibility Assessment — KDT KS-833DP

> `assessment: MCA-KS-833DP@0.1` · `profile: kdt.saw.ks_833dp@0.1-research-draft` · `contract: DELIVERY-KS-833DP@0.1-draft`
...
- Validate panel/beam dimensions against documented cutting length and depth.
- Confirm cut positions and blade projection stay within documented limits.
- Reject cut lists exceeding documented capacity.
