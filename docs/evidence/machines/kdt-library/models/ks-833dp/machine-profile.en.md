...
| Region | Global |
| Purpose | Beam saw; compatible with various order-splitting software |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/217.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | Front feeding ~3330 x rear ~3000; KDT-official page 217 (products_detail) is image-only - values not OCR-legible | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/217.html) |
...
| Automation (`automation`) | Dual-pusher (DP) rear-loading beam saw | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/217.html) |
| Footprint / power / weight (`footprint_power_weight`) | Unknown | Unknown | none |

## 4. Documented conflicts (not resolved)

**Conflict:** KDT-official detail page 217 has image-only specs (not OCR-legible). No legible official numeric table located; values remain Unknown per grounding rule.
