# Machine Profile — KDT Whole Plant Planning 2
...
| Model | **Whole Plant Planning 2** |
| Aliases | none |
| Family | Project Planning (Lines/Cells) |
| Catalog status | current-global |
| Region | Global |
| Purpose | Whole-plant intelligent production planning solution |
...
| Automation (`automation`) | Integration/solution concept (no discrete machine spec table published) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/110.html) |
