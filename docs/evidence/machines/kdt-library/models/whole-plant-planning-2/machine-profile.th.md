# โปรไฟล์เครื่องจักร (Machine Profile) — KDT Whole Plant Planning 2

> `profile_id: kdt.project_planning.whole_plant_planning_2@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Project Planning (Lines/Cells)** — Whole-plant intelligent production planning solution
...
| รุ่น | **Whole Plant Planning 2** |
| ชื่อเรียกอื่น (aliases) | ไม่มี |
| ตระกูล | Project Planning (Lines/Cells) |
| สถานะในแค็ตตาล็อก | current-global |
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Whole-plant intelligent production planning solution |
...
| ระบบอัตโนมัติ (`automation`) | Integration/solution concept (no discrete machine spec table published) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/110.html) |
