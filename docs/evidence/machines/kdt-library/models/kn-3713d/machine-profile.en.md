...
| Region | Global |
| Purpose | Nesting; 13.2kW high-power spindle |
...
|---|---|---|---|
| Working envelope (`envelope`) | Working X/Y/Z 4260 x 2150 x 100mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/173.html) |
| Capabilities (`capabilities`) | Main spindle 13.2kW HSK-F63; drill head 10V; 1.5kW high-performance motor (listing) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/173.html) |
| Capacities (`capacities`) | Max moving speed X/Y/Z 80/80/30 m/min; vacuum 6 zones, 244*2 m3/h | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/173.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | 12-post Rotary ATC | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/173.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total power 32.8kW; overall 5660L x 3350W x 2415H mm; dust Ø200*1; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/173.html) |
