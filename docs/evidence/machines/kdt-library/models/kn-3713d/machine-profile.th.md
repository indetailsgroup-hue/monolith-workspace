# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KN-3713D

> `profile_id: kdt.nesting.kn_3713d@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Nesting Tech** — Nesting; 13.2kW high-power spindle
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Nesting; 13.2kW high-power spindle |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Working X/Y/Z 4260 x 2150 x 100mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/173.html) |
| ความสามารถ (`capabilities`) | Main spindle 13.2kW HSK-F63; drill head 10V; 1.5kW high-performance motor (listing) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/173.html) |
| กำลัง / ความจุ (`capacities`) | Max moving speed X/Y/Z 80/80/30 m/min; vacuum 6 zones, 244*2 m3/h | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/173.html) |
...
| ระบบอัตโนมัติ (`automation`) | 12-post Rotary ATC | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/173.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 32.8kW; overall 5660L x 3350W x 2415H mm; dust Ø200*1; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/173.html) |
