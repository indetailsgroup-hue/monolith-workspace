# โปรไฟล์เครื่องจักร (Machine Profile) — KDT Key-Hole Machining Cell

> `profile_id: kdt.project_planning.key_hole_machining_cell@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Project Planning (Lines/Cells)** — Automated key-hole machining cell
...
| ระบบอัตโนมัติ (`automation`) | Integration/solution concept (no discrete machine spec table published) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/93.html) |
