# Machine Profile — KDT Key-Hole Machining Cell
...
| Model | **Key-Hole Machining Cell** |
| Aliases | none |
| Family | Project Planning (Lines/Cells) |
| Catalog status | current-global |
| Region | Global |
| Purpose | Automated key-hole machining cell |
...
| Automation (`automation`) | Integration/solution concept (no discrete machine spec table published) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/93.html) |
