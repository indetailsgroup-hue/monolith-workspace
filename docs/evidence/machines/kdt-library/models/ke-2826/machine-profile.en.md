# Machine Profile — KDT KE-2826

> `profile_id: kdt.edge_bander.ke_2826@0.1-research-draft` · as-of: 2026-07-17
> [TH edition / ฉบับภาษาไทย](machine-profile.th.md)

**Banding Machine (Edge Bander)** — Maglev-driven horizontal end-cutter edge bander (high feed)
...
| Region | Global |
| Purpose | Maglev-driven horizontal end-cutter edge bander (high feed) |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/203.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | ≥195 mm; W Min. Panel Size(mm); T 9-60 mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/203.html) |
| Capabilities (`capabilities`) | tape 0.4-3 mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/203.html) |
| Capacities (`capacities`) | feed/speed 26-32-36-42 m/min | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/203.html) |
