# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KE-2826
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Maglev-driven horizontal end-cutter edge bander (high feed) |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/203.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | ≥195 mm; W Min. Panel Size(mm); T 9-60 mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/203.html) |
| ความสามารถ (`capabilities`) | tape 0.4-3 mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/203.html) |
| กำลัง / ความจุ (`capacities`) | feed/speed 26-32-36-42 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/203.html) |
