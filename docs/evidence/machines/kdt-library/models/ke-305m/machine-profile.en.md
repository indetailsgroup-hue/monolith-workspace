# Machine Profile — KDT KE-305M

> `profile_id: kdt.edge_bander.ke_305m@0.1-research-draft` · as-of: 2026-07-17
> [TH edition / ฉบับภาษาไทย](machine-profile.th.md)

**Banding Machine (Edge Bander)** — Manual edge bander (M variant)
...
| Region | Global |
| Purpose | Manual edge bander (M variant) |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/1448601899195064320.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | T 9~55 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/1448601899195064320.html) |
| Capabilities (`capabilities`) | tape 0.4-3 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/1448601899195064320.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | power 1.98; size 1010L*1060W*1000H | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/1448601899195064320.html) |
