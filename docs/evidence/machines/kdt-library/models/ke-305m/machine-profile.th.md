# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KE-305M
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Manual edge bander (M variant) |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/1448601899195064320.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | T 9~55 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/1448601899195064320.html) |
| ความสามารถ (`capabilities`) | tape 0.4-3 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/1448601899195064320.html) |
...
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | power 1.98; size 1010L*1060W*1000H | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/1448601899195064320.html) |
