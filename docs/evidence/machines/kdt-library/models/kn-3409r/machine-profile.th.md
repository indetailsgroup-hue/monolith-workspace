# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KN-3409R

> `profile_id: kdt.nesting.kn_3409r@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Nesting Tech** — Nesting; 3-axis ball screw transmission
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Nesting; 3-axis ball screw transmission |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Working X/Y/Z 2860 x 1260 x 50mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/17.html) |
| ความสามารถ (`capabilities`) | Main spindle 12kW ISO-30; 3-axis ball-screw transmission (XYZ high-precision screw drive) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/17.html) |
| กำลัง / ความจุ (`capacities`) | Max moving speed X/Y/Z 45/60/30 m/min; vacuum 5 zones, 244 m3/h | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/17.html) |
...
| ระบบอัตโนมัติ (`automation`) | 2 x 12-post Rotary ATC (24-position disc magazine) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/17.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 23.1kW; overall 3610L x 2410W x 2415H mm; dust Ø200*1; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/17.html) |
