...
| Region | Global |
| Purpose | Nesting; 3-axis ball screw transmission |
...
|---|---|---|---|
| Working envelope (`envelope`) | Working X/Y/Z 2860 x 1260 x 50mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/17.html) |
| Capabilities (`capabilities`) | Main spindle 12kW ISO-30; 3-axis ball-screw transmission (XYZ high-precision screw drive) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/17.html) |
| Capacities (`capacities`) | Max moving speed X/Y/Z 45/60/30 m/min; vacuum 5 zones, 244 m3/h | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/17.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | 2 x 12-post Rotary ATC (24-position disc magazine) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/17.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total power 23.1kW; overall 3610L x 2410W x 2415H mm; dust Ø200*1; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/17.html) |
