# Machine Profile — KDT Kaifeng drilling production line
...
| Model | **Kaifeng drilling production line** |
| Aliases | none |
| Family | Project Planning (Lines/Cells) |
| Catalog status | current-global |
| Region | Global |
| Purpose | Drilling production line |
...
| Automation (`automation`) | Integration/solution concept (no discrete machine spec table published) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/111.html) |
