# โปรไฟล์เครื่องจักร (Machine Profile) — KDT Kaifeng drilling production line

> `profile_id: kdt.project_planning.kaifeng_drilling_production_line@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Project Planning (Lines/Cells)** — Drilling production line
...
| ระบบอัตโนมัติ (`automation`) | Integration/solution concept (no discrete machine spec table published) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/111.html) |
