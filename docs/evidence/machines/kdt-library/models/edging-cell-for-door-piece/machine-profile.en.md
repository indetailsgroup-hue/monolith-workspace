# Machine Profile — KDT Edging Cell for Door Piece
...
| Model | **Edging Cell for Door Piece** |
| Aliases | none |
| Family | Project Planning (Lines/Cells) |
| Catalog status | current-global |
| Region | Global |
| Purpose | Automated edging cell for door pieces |
...
| Automation (`automation`) | Integration/solution concept (no discrete machine spec table published) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/94.html) |
