# โปรไฟล์เครื่องจักร (Machine Profile) — KDT Edging Cell for Door Piece

> `profile_id: kdt.project_planning.edging_cell_for_door_piece@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Project Planning (Lines/Cells)** — Automated edging cell for door pieces
...
| ระบบอัตโนมัติ (`automation`) | Integration/solution concept (no discrete machine spec table published) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/94.html) |
