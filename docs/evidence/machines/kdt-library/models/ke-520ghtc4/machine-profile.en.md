# Machine Profile — KDT KE-520GHTC4

> `profile_id: kdt.edge_bander.ke_520ghtc4@0.1-research-draft` · as-of: 2026-07-17
...
| Region | Global |
| Purpose | Edge bander |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/208.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | ≥120; W ≥60; T 8-60 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/208.html) |
| Capabilities (`capabilities`) | tape 0.4-3 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/208.html) |
| Capacities (`capacities`) | feed/speed 18-26 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/208.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | power 39.17; size 11315L*990W*1960H mm; dust Ø125×9 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/208.html) |
