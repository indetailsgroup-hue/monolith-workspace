# Machine Profile — KDT KB-526KUBT

> `profile_id: kdt.edge_bander.kb_526kubt@0.1-research-draft` · as-of: 2026-07-17
> [TH edition / ฉบับภาษาไทย](machine-profile.th.md)

**Banding Machine (Edge Bander)** — Laser edge bander
...
| Region | Global |
| Purpose | Laser edge bander |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/205.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | T 8-60 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/205.html) |
| Capabilities (`capabilities`) | tape 0.4-3 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/205.html) |
| Capacities (`capacities`) | feed/speed 18-22-26-30 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/205.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | power 38.08; size 10680L*1150W*1960H mm; dust Ø125×8 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/205.html) |
