# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KB-526KUBT
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Laser edge bander |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/205.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | T 8-60 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/205.html) |
| ความสามารถ (`capabilities`) | tape 0.4-3 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/205.html) |
| กำลัง / ความจุ (`capacities`) | feed/speed 18-22-26-30 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/205.html) |
...
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | power 38.08; size 10680L*1150W*1960H mm; dust Ø125×8 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/205.html) |
