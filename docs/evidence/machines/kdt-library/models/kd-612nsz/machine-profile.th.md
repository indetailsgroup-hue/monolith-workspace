# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KD-612NSZ
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Six-sided drilling; smart switch tool |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel L 70-3000mm x W 50-1220mm (30-50 when L<=1000) x T 9-60mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/62.html) |
| ความสามารถ (`capabilities`) | Drills: Upper 26V+18H, Lower 9V; spindles 1x5.5kW + 1x3.5kW; smart switch tool | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/62.html) |
| กำลัง / ความจุ (`capacities`) | Max feeding speed 140 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/62.html) |
...
| ระบบอัตโนมัติ (`automation`) | Through-feed; smart switch tool | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/62.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total spindle power 28.22kW; overall 6040L x 3140W x 2190H mm; dust Ø200*2+Ø150*1+Ø100*1; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/62.html) |
