# Machine Profile — KDT KHM-680

> `profile_id: kdt.automation.khm_680@0.1-research-draft` · as-of: 2026-07-17
> [TH edition / ฉบับภาษาไทย](machine-profile.th.md)

**Automation** — Key-hole & hinge / lock machining center with saw
...
| Region | Global |
| Purpose | Key-hole & hinge / lock machining center with saw |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/220.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | 1800×300 (mm); T 30-70 (mm) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/220.html) |
| Capabilities (`capabilities`) | 5.5 kW（Ø300×Ø30）; 1.5 kW（Ø120×Ø22） | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/220.html) |
| Capacities (`capacities`) | feed/speed 40(m/min) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/220.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | power 39.3 (kW); size 5570L*3825W*2755H mm; weight 4500 (kg); dust Ø140*1 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/220.html) |
