# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KHM-680
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Key-hole & hinge / lock machining center with saw |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/220.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | 1800×300 (mm); T 30-70 (mm) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/220.html) |
| ความสามารถ (`capabilities`) | 5.5 kW（Ø300×Ø30）; 1.5 kW（Ø120×Ø22） | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/220.html) |
| กำลัง / ความจุ (`capacities`) | feed/speed 40(m/min) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/220.html) |
...
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | power 39.3 (kW); size 5570L*3825W*2755H mm; weight 4500 (kg); dust Ø140*1 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/220.html) |
