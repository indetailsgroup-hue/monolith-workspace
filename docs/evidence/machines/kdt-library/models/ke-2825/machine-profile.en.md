# Machine Profile — KDT KE-2825

> `profile_id: kdt.edge_bander.ke_2825@0.1-research-draft` · as-of: 2026-07-17
> [TH edition / ฉบับภาษาไทย](machine-profile.th.md)

**Banding Machine (Edge Bander)** — Maglev-driven horizontal end-cutter edge bander
...
| Region | Global |
| Purpose | Maglev-driven horizontal end-cutter edge bander |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/193.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | ≥195; W Min. Panel Size(mm); T 9-60 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/193.html) |
| Capabilities (`capabilities`) | tape 0.4-3 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/193.html) |
| Capacities (`capacities`) | feed/speed 32-36-42 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/193.html) |
