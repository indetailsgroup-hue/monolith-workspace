# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KE-668JGZBU(50)
...
| รุ่น | **KE-668JGZBU(50)** |
| ชื่อเรียกอื่น (aliases) | KE-668JGZBU |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel T 9-60mm (std) / 9-36mm (laser); sides edging 50x300mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/129.html) |
| ความสามารถ (`capabilities`) | Edge bander w/ Laser 3.0 S; standard tape 0.4-3mm, laser 0.8-3mm; pressure beam with V-belts (sibling KE-668JGBU(50)) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/129.html) |
| กำลัง / ความจุ (`capacities`) | Feeding speed 15-20-24 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/129.html) |
...
| ระบบอัตโนมัติ (`automation`) | Laser edge banding (Laser 3.0 S) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/129.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 39.01kW (+3.0 laser); overall 10292L x 990W x 1830H mm; dust Ø100*2+Ø125*7+Ø75*1; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/129.html) |

## 4. ข้อขัดแย้งที่บันทึกไว้ (ไม่ตัดสินให้)

**ข้อขัดแย้ง (Conflict):** Non-laser sibling KE-668JGBU(50) (exhibition 130): 29.14kW, feed 15-24, 10292x990x1960H, dust Ø100*2+Ø125*7.
