# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KS-843HL
...
| รุ่น | **KS-843HL** |
| ชื่อเรียกอื่น (aliases) | KS-843L, KS-843D |
| ตระกูล | Saw Tech |
| สถานะในแค็ตตาล็อก | current-global |
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Panel saw; twin pusher / automatic rear-loading |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Front feeding 4280x4280x120 / rear feeding 4000x2200mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/2.html) |
| ความสามารถ (`capabilities`) | Twin pusher; main blade motor 18.5kW (optional 22 variable frequency); scoring 2.2kW; 11 grippers | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/2.html) |
| กำลัง / ความจุ (`capacities`) | Sawing speed 120 m/min; carrier return 150 m/min; max feeding 95 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/2.html) |
...
| ระบบอัตโนมัติ (`automation`) | Twin-pusher structure | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/2.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 38.5kW; overall 12755L x 6595W x 2030H mm; weight 11300kg; dust Ø125*3+Ø200*2 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/2.html) |
