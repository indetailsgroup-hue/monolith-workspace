# Compatibility Assessment — KDT Flexible Automation Solution 2 (cell)

> `assessment: MCA-FLEXIBLE-AUTOMATION-SOLUTION-2-CELL@0.1` · `profile: kdt.automation.flexible_automation_solution_2_cell@0.1-research-draft` · `contract: DELIVERY-FLEXIBLE-AUTOMATION-SOLUTION-2-CELL@0.1-draft`
