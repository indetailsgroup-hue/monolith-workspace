# โปรไฟล์เครื่องจักร (Machine Profile) — KDT Flexible Automation Solution 2 (cell)

> `profile_id: kdt.automation.flexible_automation_solution_2_cell@0.1-research-draft` · as-of: 2026-07-17
...
| รุ่น | **Flexible Automation Solution 2 (cell)** |
