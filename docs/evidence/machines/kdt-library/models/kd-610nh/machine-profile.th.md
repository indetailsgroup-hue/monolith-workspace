# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KD-610NH

> `profile_id: kdt.six_sided_drill.kd_610nh@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Six-sided drilling** — Six-sided drilling; 3 drilling spindles in X-direction
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Six-sided drilling; 3 drilling spindles in X-direction |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Panel L 70-3000mm x W 30-1000mm x T 9-60mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/191.html) |
| ความสามารถ (`capabilities`) | Drills: Upper 13V+10H+1S, Lower 9V; spindles 1x5.5kW + 1x3.5kW; 3 drilling spindles in X-direction | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/191.html) |
| กำลัง / ความจุ (`capacities`) | Max feeding speed 140 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/191.html) |
...
| ระบบอัตโนมัติ (`automation`) | Through-feed six-sided drilling | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/191.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total spindle power 21.9kW; overall 5270L x 2277W x 2190H mm; dust Ø200*1+Ø150*1; weight Unknown | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/191.html) |
