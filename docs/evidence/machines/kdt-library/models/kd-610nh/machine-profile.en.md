...
| Region | Global |
| Purpose | Six-sided drilling; 3 drilling spindles in X-direction |
...
|---|---|---|---|
| Working envelope (`envelope`) | Panel L 70-3000mm x W 30-1000mm x T 9-60mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/191.html) |
| Capabilities (`capabilities`) | Drills: Upper 13V+10H+1S, Lower 9V; spindles 1x5.5kW + 1x3.5kW; 3 drilling spindles in X-direction | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/191.html) |
| Capacities (`capacities`) | Max feeding speed 140 m/min | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/191.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | Through-feed six-sided drilling | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/191.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total spindle power 21.9kW; overall 5270L x 2277W x 2190H mm; dust Ø200*1+Ø150*1; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/191.html) |
