# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KHM-626
...
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/201.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | 1800*3000(mm); W 300-1100(mm); T 30-60(mm) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/201.html) |
| ความสามารถ (`capabilities`) | Three Horizontal1.5kW(ER20)+0.75kW(ER20) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/201.html) |
| กำลัง / ความจุ (`capacities`) | feed/speed 60(m/min) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/201.html) |
...
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | power 16.5(kw); size 4085L*2440W*1400H(mm); dust ∅150*3 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/201.html) |
