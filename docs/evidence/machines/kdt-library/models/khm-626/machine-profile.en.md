# Machine Profile — KDT KHM-626

> `profile_id: kdt.automation.khm_626@0.1-research-draft` · as-of: 2026-07-17
...
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/201.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | 1800*3000(mm); W 300-1100(mm); T 30-60(mm) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/201.html) |
| Capabilities (`capabilities`) | Three Horizontal1.5kW(ER20)+0.75kW(ER20) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/201.html) |
| Capacities (`capacities`) | feed/speed 60(m/min) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/201.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | power 16.5(kw); size 4085L*2440W*1400H(mm); dust ∅150*3 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/201.html) |
