# Machine Profile — KDT KE-2368JHSKADC4

> `profile_id: kdt.edge_bander.ke_2368jhskadc4@0.1-research-draft` · as-of: 2026-07-17
> [TH edition / ฉบับภาษาไทย](machine-profile.th.md)

**Banding Machine (Edge Bander)** — Double-line (back and forth) edge bander
...
| Model | **KE-2368JHSKADC4** |
| Aliases | none |
| Family | Banding Machine (Edge Bander) |
| Catalog status | current-global |
| Region | Global |
| Purpose | Double-line (back and forth) edge bander |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/192.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | ≥285; W Min. Panel Size(mm); T 9-60 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/192.html) |
| Capabilities (`capabilities`) | tape 0.4-3 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/192.html) |
| Capacities (`capacities`) | feed/speed 20-26 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/192.html) |
