# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KE-2368JHSKADC4
...
| รุ่น | **KE-2368JHSKADC4** |
| ชื่อเรียกอื่น (aliases) | ไม่มี |
| ตระกูล | Banding Machine (Edge Bander) |
| สถานะในแค็ตตาล็อก | current-global |
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Double-line (back and forth) edge bander |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/192.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | ≥285; W Min. Panel Size(mm); T 9-60 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/192.html) |
| ความสามารถ (`capabilities`) | tape 0.4-3 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/192.html) |
| กำลัง / ความจุ (`capacities`) | feed/speed 20-26 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/192.html) |
