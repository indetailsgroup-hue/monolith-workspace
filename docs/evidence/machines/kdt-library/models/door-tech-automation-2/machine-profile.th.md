# โปรไฟล์เครื่องจักร (Machine Profile) — KDT Door-Tech Automation 2

> `profile_id: kdt.project_planning.door_tech_automation_2@0.1-research-draft` · as-of: 2026-07-17
> [EN edition](machine-profile.en.md)

**Project Planning (Lines/Cells)** — Door manufacturing automation line
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Sibling Door-Tech Automation 1 (exhibition 86): whole-line height 960mm; size L 1800-3000 x W 300-1100mm; workpiece T 10-25mm; max weight 100kg (Door-Tech Automation 2 exact values Unknown) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/86.html) |
| ความสามารถ (`capabilities`) | Door-piece automation line (6 edging modes for options on sibling '1') | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/86.html) |
...
| ระบบอัตโนมัติ (`automation`) | Door-tech automation line; roller conveyor stacking 1500/1400mm (sibling '1') | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/86.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Unknown | ยังไม่ทราบ (Unknown) | ไม่มี |

## 4. ข้อขัดแย้งที่บันทึกไว้ (ไม่ตัดสินให้)

**ข้อขัดแย้ง (Conflict):** Door-Tech Automation 2 page (id 92) shows no numeric table; values shown are for sibling Door-Tech Automation 1 (id 86). '2'-exact specs Unknown.
...
**3 / 7** — จำนวนกลุ่มข้อมูลเทคนิคที่มีค่าและมีแหล่งอ้างอิง จากทั้งหมด 7 กลุ่ม · ณ วันที่ 2026-07-17
