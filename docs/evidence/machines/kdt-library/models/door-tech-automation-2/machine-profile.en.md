# Machine Profile — KDT Door-Tech Automation 2
...
| Model | **Door-Tech Automation 2** |
| Aliases | none |
| Family | Project Planning (Lines/Cells) |
| Catalog status | current-global |
| Region | Global |
| Purpose | Door manufacturing automation line |
...
|---|---|---|---|
| Working envelope (`envelope`) | Sibling Door-Tech Automation 1 (exhibition 86): whole-line height 960mm; size L 1800-3000 x W 300-1100mm; workpiece T 10-25mm; max weight 100kg (Door-Tech Automation 2 exact values Unknown) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/86.html) |
| Capabilities (`capabilities`) | Door-piece automation line (6 edging modes for options on sibling '1') | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/86.html) |
...
| Automation (`automation`) | Door-tech automation line; roller conveyor stacking 1500/1400mm (sibling '1') | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/86.html) |
| Footprint / power / weight (`footprint_power_weight`) | Unknown | Unknown | none |

## 4. Documented conflicts (not resolved)

**Conflict:** Door-Tech Automation 2 page (id 92) shows no numeric table; values shown are for sibling Door-Tech Automation 1 (id 86). '2'-exact specs Unknown.
