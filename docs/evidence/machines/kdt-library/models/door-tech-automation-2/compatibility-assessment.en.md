# Compatibility Assessment — KDT Door-Tech Automation 2

> `assessment: MCA-DOOR-TECH-AUTOMATION-2@0.1` · `profile: kdt.project_planning.door_tech_automation_2@0.1-research-draft` · `contract: DELIVERY-DOOR-TECH-AUTOMATION-2@0.1-draft`
...
- Validate the whole-line workpiece flow against each constituent machine's documented envelope.
- Confirm hand-off geometry between stations is within documented limits.
- Reject work orders exceeding any station's documented capacity.
