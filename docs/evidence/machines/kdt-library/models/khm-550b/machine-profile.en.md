...
| Region | Global |
| Purpose | Four-side cutter / key-hole hinge machining |
...
|---|---|---|---|
| Working envelope (`envelope`) | Min working 1800x300mm; max working (L*W) 3000x1100mm; working thickness 30-60mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/89.html) |
| Capabilities (`capabilities`) | Four-side cutter; main saw 3x5.5kW (Ø300xØ30); scoring 3x1.5kW (Ø120xØ22); centering workpiece positioning | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/89.html) |
| Capacities (`capacities`) | Max moving speed 40 m/min; crossbeam servo 1.5kW; vacuum pump 5.5kW; table height 960mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/89.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | Servo positioning vacuum sucker; centering | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/89.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total power 35.5kW; overall 5158L x 2700W x 2396H mm; weight 3500kg; dust Ø200*1 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/89.html) |
