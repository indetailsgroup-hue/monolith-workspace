...
| Region | Global |
| Purpose | Edge bander; gluing and pressing unit |
...
|---|---|---|---|
| Working envelope (`envelope`) | Panel T 9-60mm; panel L >=285mm; min panel 285x285mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/59.html) |
| Capabilities (`capabilities`) | Gluing and pressing unit (double-ended); tape 0.4-3mm | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/59.html) |
| Capacities (`capacities`) | Feeding speed 13-18 m/min | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/59.html) |
| Controller / HMI (`controller_hmi`) | Unknown | Unknown | none |
| Native / import formats (`native_import_formats`) | Unknown | Unknown | none |
| Automation (`automation`) | Double-ended gluing/pressing station | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/59.html) |
| Footprint / power / weight (`footprint_power_weight`) | Total power 39.94kW; overall 6274L x 4300W x 1730H mm; dust Ø125*8+Ø100*4; weight Unknown | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/Exhibitions_product_detail_1/59.html) |
