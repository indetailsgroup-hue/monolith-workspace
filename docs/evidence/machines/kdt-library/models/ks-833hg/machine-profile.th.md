# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KS-833HG
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Beam saw; front+rear lift table feeding |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/216.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | Front feeding 3330Lx3330Wx120H mm; rear lift-table feeding 3000Lx1600W mm | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/216.html) |
| ความสามารถ (`capabilities`) | Main blade motor 18.5kW (optional 22kW VFD); scoring blade motor 2.2kW | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/216.html) |
| กำลัง / ความจุ (`capacities`) | Saw speed 95 m/min; saw carrier return speed 120 m/min | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/216.html) |
...
| ระบบอัตโนมัติ (`automation`) | 9 grippers; front + rear lift-table feeding | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/216.html) |
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | Total power 36kW; overall 7725x5645x2030mm; weight 7100kg; dust Ø100*2+Ø125*1+Ø200*2 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/216.html) |
