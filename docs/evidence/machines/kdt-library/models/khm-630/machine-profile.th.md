# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KHM-630
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Key-hole & hinge / door-lock machining |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/202.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | 1800*3000(mm); W 300-1100(mm); T 30-70(mm) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/202.html) |
| ความสามารถ (`capabilities`) | Horizontal / Verticalvertical spindle 6kW(ER32)+1.5kW(ER20) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/202.html) |
| กำลัง / ความจุ (`capacities`) | feed/speed 60(m/min) | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/202.html) |
...
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | power 20.25(kw); size 3785L*2495W*2090H(mm); dust ∅150*1 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/202.html) |
