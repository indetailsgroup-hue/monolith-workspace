# Machine Profile — KDT KHM-630

> `profile_id: kdt.automation.khm_630@0.1-research-draft` · as-of: 2026-07-17
> [TH edition / ฉบับภาษาไทย](machine-profile.th.md)

**Automation** — Key-hole & hinge / door-lock machining
...
| Region | Global |
| Purpose | Key-hole & hinge / door-lock machining |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/202.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | 1800*3000(mm); W 300-1100(mm); T 30-70(mm) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/202.html) |
| Capabilities (`capabilities`) | Horizontal / Verticalvertical spindle 6kW(ER32)+1.5kW(ER20) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/202.html) |
| Capacities (`capacities`) | feed/speed 60(m/min) | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/202.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | power 20.25(kw); size 3785L*2495W*2090H(mm); dust ∅150*1 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/202.html) |
