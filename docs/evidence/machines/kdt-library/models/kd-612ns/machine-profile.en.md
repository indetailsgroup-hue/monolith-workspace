# Machine Profile — KDT KD-612NS

> `profile_id: kdt.six_sided_drill.kd_612ns@0.1-research-draft` · as-of: 2026-07-17
> [TH edition / ฉบับภาษาไทย](machine-profile.th.md)

**Six-sided drilling** — Six-sided CNC drilling center
...
| Region | Global |
| Purpose | Six-sided CNC drilling center |
| Source URLs | [en.kdtmac.com](https://en.kdtmac.com/products_detail/219.html) |
...
|---|---|---|---|
| Working envelope (`envelope`) | 70-3000; W 50-1220 30-50（L≤1000）; T 9-60 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/219.html) |
| Capabilities (`capabilities`) | Upper 26V+18H+Lower 9V; 1*5.5 1*3.5 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/219.html) |
| Capacities (`capacities`) | feed/speed 140 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/219.html) |
...
| Footprint / power / weight (`footprint_power_weight`) | power 28.22; size 6040L*2855W*2190H; dust Ø200*2+Ø150*1+Ø100*1 | Verified in documents | [en.kdtmac.com](https://en.kdtmac.com/products_detail/219.html) |
