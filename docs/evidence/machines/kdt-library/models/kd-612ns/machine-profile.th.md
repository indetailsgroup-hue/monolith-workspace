# โปรไฟล์เครื่องจักร (Machine Profile) — KDT KD-612NS
...
| ภูมิภาค | Global |
| วัตถุประสงค์การใช้งาน | Six-sided CNC drilling center |
| แหล่งที่มา (URLs) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/219.html) |
...
|---|---|---|---|
| พื้นที่ทำงาน / ระยะวิ่ง (`envelope`) | 70-3000; W 50-1220 30-50（L≤1000）; T 9-60 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/219.html) |
| ความสามารถ (`capabilities`) | Upper 26V+18H+Lower 9V; 1*5.5 1*3.5 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/219.html) |
| กำลัง / ความจุ (`capacities`) | feed/speed 140 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/219.html) |
...
| ขนาด / กำลังไฟ / น้ำหนัก (`footprint_power_weight`) | power 28.22; size 6040L*2855W*2190H; dust Ø200*2+Ø150*1+Ø100*1 | ยืนยันจากเอกสาร (Verified in documents) | [en.kdtmac.com](https://en.kdtmac.com/products_detail/219.html) |
