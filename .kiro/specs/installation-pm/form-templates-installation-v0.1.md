...
- Template = **ต่อประเภทห้อง × เลนช่าง** — ทีมมาตรฐาน 5 คน แบ่ง 3 เลน (ช่าง 1/2/3 ตาม checklist; อีก 2 คนหมุนช่วย)
- **กติกาความคืบหน้า:** ห้องเสร็จ = ทุกเลนของห้องนั้นติ๊กครบ + ถ่ายรูป **Wrapping** เข้า capture `installation_proof` (ทุกเลนจบด้วย ทำความสะอาด → Wrapping = จุดถ่ายรูปธรรมชาติ)
...
- ทีม 5 คนแต่ checklist มี 3 เลน — อีก 2 คนทำเลนไหน (หมุนช่วย? งานยก?) → มีผล assignee model
